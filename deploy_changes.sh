...
#      irajkoohi/MultiModalRag-data and are downloaded at Space startup.
#
...
#                       repo_id='irajkoohi/MultiModalRag-data',
#                       repo_type='dataset')
#       " data/yourfile.pdf
#
# NOTES:
...
echo "   Dataset: https://huggingface.co/datasets/irajkoohi/MultiModalRag-data"
